...
# swap0  (no swap) - Memory:  150 MB - Load:   3 sec - Query:    20 ms (mean)
# swap1 (one swap) - Memory:  990 MB - Load:  30 sec - Query:  1000 ms (mean)
# swap2 (two swap) - Memory: 3520 MB - Load: 100 sec - Query: 12000 ms (mean)
SWAP = ("swap0", "swap1")
